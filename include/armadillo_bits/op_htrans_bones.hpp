...
class op_htrans
  ...
  template<typename eT>
  arma_inline static void apply(Mat<eT>& out, const Mat<eT>& A, const bool is_alias, const typename arma_not_cx<eT>::result* junk = 0);
  
  template<typename eT>
  inline static void apply(Mat<eT>& out, const Mat<eT>& A, const bool is_alias, const typename arma_cx_only<eT>::result* junk = 0);
...
class op_htrans2
  ...
  template<typename eT>
  arma_inline static void apply(Mat<eT>& out, const Mat<eT>& A, const eT val, const bool is_alias, const typename arma_not_cx<eT>::result* junk = 0);
  
  template<typename eT>
  inline static void apply(Mat<eT>& out, const Mat<eT>& A, const eT val, const bool is_alias, const typename arma_cx_only<eT>::result* junk = 0);
